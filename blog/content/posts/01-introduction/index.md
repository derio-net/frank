...
1. Building the Foundation — Bootstrapping Talos, configuring nodes, installing Cilium *(coming soon)*
2. Persistent Storage — Longhorn across heterogeneous disks *(coming soon)*
3. GPU Compute — NVIDIA and Intel iGPU via DRA *(coming soon)*
4. GitOps Everything — ArgoCD App-of-Apps *(coming soon)*
5. Fun Stuff — Controlling RGB LEDs from Kubernetes *(coming soon)*
