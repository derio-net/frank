...
cover:
  image: cover.png
  alt: "Frank the cluster monster unplugging from a dying cloud and wiring up his own kanban server"
  relative: true
---
...
- [Post 21: Secure Agent Pod]({{< relref "/building/21-secure-agent-pod" >}}) — the agent workstation that connects to vk-remote
- [Post 24: In-Cluster Ingress]({{< relref "/building/24-in-cluster-ingress" >}}) — Traefik and Authentik forward-auth setup
- [Post 25: VK Relay]({{< relref "/building/25-vk-relay" >}}) — the WebSocket relay sidecar added on top of this deployment
