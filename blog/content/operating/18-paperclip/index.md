...
cover:
  image: cover.png
  alt: "Frank reviewing an org chart of AI agents on a clipboard"
  relative: true
---

This is the operational companion to [Paperclip — AI Agent Orchestrator]({{< relref "/building/15-paperclip" >}}). That post explains the architecture and deployment. This one covers health checks, database access, secret management, and common failure modes.
...
- **No Argo Rollouts for Paperclip.** The RWO PVC makes it incompatible with blue-green and canary strategies. It runs as a plain Deployment with Recreate strategy. See [Operating on Progressive Delivery]({{< relref "/operating/12-progressive-delivery" >}}) for context on the Phase 3 revert.
...
- [Building Post: Paperclip]({{< relref "/building/15-paperclip" >}}) — Architecture and deployment walkthrough
- [Operating on Progressive Delivery]({{< relref "/operating/12-progressive-delivery" >}}) — Context on why Paperclip isn't a Rollout
