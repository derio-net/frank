...
cover:
  image: cover.png
  alt: "Frank at an operations desk monitoring three stacked server components"
  relative: true
---

This is the operational companion to [VK Remote — Self-Hosting the Kanban Backend Before the Cloud Dies]({{< relref "/building/26-vk-remote-self-host" >}}). That post explains the architecture and deployment. This one is the day-to-day runbook.
...
- [Building Post: VK Remote Self-Host]({{< relref "/building/26-vk-remote-self-host" >}})
- [Operating on VK Relay]({{< relref "/operating/20-vk-relay" >}})
- [Operating on Secure Agent Pod]({{< relref "/operating/14-secure-agent-pod" >}})
- [Operating on Authentication]({{< relref "/operating/08-auth" >}})
