...
cover:
  image: cover.png
  alt: "Frank monitoring CI/CD pipeline status on an operations dashboard"
  relative: true
---

Companion operations guide for [CI/CD Platform — Gitea, Tekton, Zot, and Cosign]({{< relref "/building/27-cicd-platform" >}}).
