...
cover:
  image: cover.png
  alt: "Frank pulling a glowing ethernet cable out of a terminal labelled /proc/1/environ"
  relative: true
---
...
- [Operating on Secure Agent Pod]({{< relref "/operating/14-secure-agent-pod" >}}) — Full operational guide for the pod
