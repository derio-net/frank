...
cover:
  image: cover.png
  alt: "Frank the cluster monster maintaining ingress gateway systems"
  relative: true
---

Companion operations guide for [In-Cluster Ingress — Traefik, Wildcard TLS, and a Homepage Dashboard]({{< relref "/building/24-in-cluster-ingress" >}}).
