...
The series needed a visual signature. Phase 6 generates `banner-papers.png` (1200×630, used on the section landing and as the OpenGraph image when sharing Papers links) and `banner-papers-thin.png` (a wide strip used in card thumbnails).
...
Same flow for `banner-papers-thin`. They're 1200×630 and a wide strip respectively, both checked into git as binary blobs.
