...
The series banners (`banner-papers.png`, `banner-papers-thin.png`) live at `blog/static/images/` — these are the section-level images, generated once at Phase 0 and not regenerated per paper.
