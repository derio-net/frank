...
<!-- fr:journal kind=finding scope=plan id=c9e8165d5447 created=2026-07-28T22:15:37 phase=1 state=open -->
### c9e8165d5447 · finding [open] · Phase 1's expected corpus count (13) is off by one: LINT FAIL is not a gate finding (phase 1)
