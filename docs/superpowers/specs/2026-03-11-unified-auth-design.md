...
**Date:** 2026-03-11
**Phase:** XX (to be numbered at implementation)
**Status:** Draft
...
Organization (team-alpha)  <- future, post-Phase 12
...
Four independent phases, each self-contained with rollback safety:

### Migration Phase 1 — Deploy Authentik Standalone
...
### Migration Phase 3 — Service SSO (One at a Time)
...
### Migration Phase 4 — Proxy Outpost for Remaining Services
...
- Multi-organization support (deferred to Phase 12 vClusters)
...
| 192.168.55.211 | Authentik | This phase |
