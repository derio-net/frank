...
- Credential: R2 API token stored as a K8s Secret (SOPS-encrypted in git, or via Infisical after Phase 9)
...
**Title:** "Phase 8 — Backup: Longhorn to NAS and Cloudflare R2"
