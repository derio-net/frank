...
|------|------|------|--------|------------|
| Agent Pod Restart Resilience — Implementation Plan | derio-net/frank, derio-net/agent-images | `docs/superpowers/plans/2026-04-27--agents--restart-resilience.md` | Draft (to be written) | — |
