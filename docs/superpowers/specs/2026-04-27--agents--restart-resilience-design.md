...
|------|------|------|--------|------------|
| Agent Pod Restart Resilience — Implementation Plan (frank side) | `derio-net/agent-images` | `docs/superpowers/archived-plans/2026-04-27--agents--restart-resilience.md` | Complete | — |
