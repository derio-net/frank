...
| The Frank Papers — Paper 05: GPU Scheduling for Mixed Workloads | derio-net/frank | `docs/superpowers/plans/2026-05-20--repo--frank-papers-paper-05/` | Complete (2026-05-20) — PR open for review |
| The Frank Papers — Paper 08: Backup & DR Without a Vendor Contract | derio-net/frank | `docs/superpowers/plans/2026-05-20--repo--frank-papers-paper-08/` | Complete (2026-05-20) — Paper 08 draft published on branch `paper-08`; PR open for human review |
| The Frank Papers — Paper 13: Self-Hosted CI/CD on a Homelab | derio-net/frank | `docs/superpowers/plans/2026-05-20--repo--frank-papers-paper-13/` | Complete (2026-05-20) — PR open for review |
...
| The Frank Papers — Paper 20: Edge Clusters & Public Exposure | derio-net/frank | `docs/superpowers/plans/2026-05-22--repo--frank-papers-paper-20/` | Drafting (2026-05-22) — plan only; PR open for human review |
| The Frank Papers — Paper 15: Ingress, Forward-Auth, and the Service Catalog | derio-net/frank | `docs/superpowers/plans/2026-05-22--repo--frank-papers-paper-15/` | Planning (2026-05-22) — plan drafted on branch `paper-15`; PR open for human review |
| The Frank Papers — Paper 01: Heterogeneous Hardware as a Design Choice | derio-net/frank | `docs/superpowers/plans/2026-05-22--repo--frank-papers-paper-01/` | Drafting (2026-05-22) — plan created, PR open for review of plan structure |
