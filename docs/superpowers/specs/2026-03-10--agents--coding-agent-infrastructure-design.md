# Autonomous Coding Agent Infrastructure — Design
...
- Decision deferred to implementation layer based on Talos compatibility testing
...
| Node | Zone | Role in Agents layer | Key Resources |
|------|------|-------------------|---------------|
