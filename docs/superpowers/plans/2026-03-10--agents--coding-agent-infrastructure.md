# Autonomous Coding Agent Infrastructure — Implementation Plan
...
- Existing infer layer stack operational (Ollama, LiteLLM, Infisical, ExternalSecrets)
...
```yaml
# manual-operation
id: agents-longhorn-disk-tags
layer: agents
app: longhorn
plan: docs/superpowers/plans/2026-03-10--agents--coding-agent-infrastructure.md
...
```yaml
# manual-operation
id: agents-gitea-infisical-secrets
layer: agents
app: gitea
plan: docs/superpowers/plans/2026-03-10--agents--coding-agent-infrastructure.md
...
```yaml
# manual-operation
id: agents-harbor-infisical-secrets
layer: agents
app: harbor
plan: docs/superpowers/plans/2026-03-10--agents--coding-agent-infrastructure.md
...
```yaml
# manual-operation
id: agents-n8n-infisical-secrets
layer: agents
app: n8n
plan: docs/superpowers/plans/2026-03-10--agents--coding-agent-infrastructure.md
...
```yaml
# manual-operation
id: agents-aider-infisical-secrets
layer: agents
app: aider
plan: docs/superpowers/plans/2026-03-10--agents--coding-agent-infrastructure.md
...
| ID | Layer | When | What |
|----|-------|------|------|
| `agents-longhorn-disk-tags` | agents | Before Task 1.2 | Tag HDD disks in Longhorn UI |
| `agents-gitea-infisical-secrets` | agents | Before Task 2 | Create Gitea admin creds in Infisical |
| `agents-gitea-runner-token` | agents | After Task 2 | Generate runner registration token |
| `agents-harbor-infisical-secrets` | agents | Before Task 4 | Create Harbor admin creds in Infisical |
| `agents-n8n-infisical-secrets` | agents | Before Task 5 | Create n8n encryption key in Infisical |
| `agents-aider-infisical-secrets` | agents | Before Task 6 | Create Aider LiteLLM key + Gitea token |
| `agents-n8n-workflow-setup` | agents | After Tasks 5+6 | Build n8n workflow via UI |
