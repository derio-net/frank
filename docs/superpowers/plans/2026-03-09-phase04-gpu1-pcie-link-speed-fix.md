...
phase: 4
app: gpu-operator
plan: docs/superpowers/plans/2026-03-09-phase04-gpu1-pcie-link-speed-fix.md
...
Edit `docs/superpowers/plans/2026-03-09-phase04-gpu1-pcie-link-speed-fix.md`:
- Change `status: pending` → `status: done` on both manual-operation blocks

**Step 3: Commit**

```bash
git add docs/superpowers/plans/2026-03-09-phase04-gpu1-pcie-link-speed-fix.md
