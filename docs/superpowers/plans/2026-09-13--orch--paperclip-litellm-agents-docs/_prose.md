...
4. **Manual:** the post-merge rendered-page check (the Test Plan). This phase also adds the acceptance row once super-fr#470 is fixed; the row cannot be appended today without hand-editing the matrix.
