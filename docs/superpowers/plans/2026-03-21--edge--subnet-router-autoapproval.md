...
- [ ] **Step 1: Replace the `acl.yaml` section in the ConfigMap**
...
- [ ] **Step 1: Add the `split` key under `dns.nameservers`**
...
- [ ] **Step 2: Verify the full ConfigMap is valid**

Run: `kubectl --dry-run=client -o yaml -f clusters/hop/apps/headscale/manifests/configmap.yaml`
Expected: Valid YAML output, no errors.

- [ ] **Step 3: Commit the ConfigMap changes**
...
- [ ] **Step 1: Rewrite the "Registering an Exit Node" section (line 186)**
...
- [ ] **Step 2: Add a "Split DNS" section after the new subnet router section**
...
- [ ] **Step 1: Push and let ArgoCD sync**
...
- [ ] **Step 2: Restart Headscale to pick up config changes**
...
- [ ] **Step 3: Verify ACL policy loaded**
...
- [ ] **Step 4: Tag existing raspi nodes (skip if re-registering in Steps 5-6)**
...
- [ ] **Step 7: Verify end-to-end from a mesh client (e.g., Mac)**
