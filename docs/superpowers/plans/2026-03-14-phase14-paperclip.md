# Phase 14 — Paperclip AI Orchestrator Implementation Plan
...
```yaml
# Namespace for Paperclip AI orchestrator (Phase 14)
...
- [ ] **Step 1: Execute manual operation `phase14-build-paperclip-image`**
...
- [ ] **Step 1: Execute manual operation `phase14-create-infisical-secrets`**
...
Check that `docs/runbooks/manual-operations.yaml` contains entries for `phase14-build-paperclip-image` and `phase14-create-infisical-secrets`.
