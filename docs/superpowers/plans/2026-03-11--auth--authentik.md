...
```yaml
# manual-operation
id: auth-authentik-bootstrap-secrets
layer: auth
app: authentik
...
# Layer: auth — Unified Authentication & Authorization
...
# Groups use org-aware naming for future multi-org support (tenant layer).
apiVersion: v1
kind: ConfigMap
metadata:
...
```yaml
# manual-operation
id: auth-traefik-authentik-route
layer: auth
app: authentik
plan: docs/superpowers/plans/2026-03-11--auth--authentik.md
...
```yaml
# manual-operation
id: auth-argocd-oidc-client-secret
layer: auth
app: authentik
plan: docs/superpowers/plans/2026-03-11--auth--authentik.md
...
```yaml
# manual-operation
id: auth-grafana-oidc-client-secret
layer: auth
app: authentik
plan: docs/superpowers/plans/2026-03-11--auth--authentik.md
...
```markdown
# Layer: auth — Authentication OIDC API Server Patch
