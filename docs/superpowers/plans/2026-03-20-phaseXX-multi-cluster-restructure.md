...
**Origin:** Extracted from Hop phase plan (`docs/superpowers/plans/2026-03-16-phaseXX-hop-public-edge.md`, former Task 17 / Chunk 7).

**Spec:** `docs/superpowers/specs/2026-03-20-phaseXX-multi-cluster-restructure-design.md`
