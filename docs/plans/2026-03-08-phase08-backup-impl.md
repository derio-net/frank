# Phase 08 — Backup Implementation Plan
...
Phase 8 addresses this with Longhorn's built-in backup functionality: two targets, two schedules, zero new ArgoCD applications.
